    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="form-group mb-6">
        <input type="text" class="form-control
          ...
          aria-describedby="emailHelp123" placeholder="Descripción"/>
      </div>
      <div class="form-group mb-6">
        <input type="text" class="form-control
          block
          ...
          aria-describedby="emailHelp124" placeholder="Cargo"/>
      </div>
    </div>
                          ...
                          <tr>
                              ...
                              <td>
                                <div class="btn">
                                  ...
                                  <a class="bg-red-600 text-white p-1 rounded" href="/delete">Eliminar</a>
                                </div>
                              </td>
                          </tr>
                          <tr>

  ...
  <div class="modal-dialog relative w-auto pointer-events-none">
    <div
      ...
      <div class="modal-body relative p-4">
        <form>
            <div class="mb-3 w-96">
                <label for="formFile" class="form-label inline-block mb-2 text-gray-700">Seleccionar Archivo .xlsx</label>
      ...
      <div
        ...
        <button type="button"
          ...
          data-bs-dismiss="modal">Cerrar</button>
                            ...
                            <div>
                              <button type="button" class="inline-block px-6 pt-2.5 pb-2 bg-gray-500 text-white font-medium text-xs leading-normal uppercase rounded shadow-md hover:bg-gray-600 hover:shadow-lg focus:bg-gray-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out flex align-center
                              whitespace-nowrap"
